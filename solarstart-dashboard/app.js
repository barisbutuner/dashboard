...
let yazi = document.getElementById('kayanYazi');
let pozisyon = window.innerWidth;

function kaydir() {
  pozisyon--;

  if (pozisyon < -yazi.offsetWidth) {
    pozisyon = window.innerWidth;
  }

  yazi.style.left = pozisyon + 'px';
